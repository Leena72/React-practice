        ...
        return (
            <React.Fragment>
                ...
                <div className="cart tableWrapper">
                    ...
                    <h2 className="shopHeading">SHOPPING CART</h2>
                        ...
                        <tbody>
                            {
                                this.props.cart.map((item, i) =>
                                    <tr key={i}>
                                        ...
                                        {this.state.update ?
                                            <td className="tableData"><i className="fas fa-trash-alt"
                    ...
                    {this.props.cart.length > 0 ?
                        ...
                        <React.Fragment>
                            <div className="cart-img-container">
                                <img src={"assets/download.png"} alt="shopping-cart" className="shopping-cart-img" />
                           
                            <h4 className="empty-cart  blink_me">Opps!!! Your Shopping cart is empty</h4> </div>
                        </React.Fragment>
                    }
                    <div className="checkoutBtn">
                        <button type="button" className="cart-buttons" onClick={this.upDateCart}>Update Cart</button>
                        {this.props.cart.length > 0?
                        <button type="button" className="cart-buttons" onClick={this.clearAll}>Empty Cart</button>
                        :
                        <button type="button" className="cart-buttons" onClick={this.clearAll} disaled >Empty Cart</button>
                        }
                        <button type="button" className="cart-buttons" onClick={this.continue}>Continue Shopping</button>
                        {this.props.total > 0? 
                        <button type="button" className="cart-buttons" onClick={this.checkOut}>Go to Checkout</button>
                        :
                        <button type="button" className="cart-buttons " disabled>Go to Checkout</button>
                        }
                    </div>
                </div>
                <Footer/>
